 ...
 */
package design;
import diksjtra.ComparatorDistance;
import diksjtra.Diksjtra;
...
public class Fenetre extends javax.swing.JFrame {
                        ...
                        if (running) {
                            ...
                            t = new Thread() {
                                ...
                                public void run() {
                                    ...
                                    Chaine listSouris = new Chaine(new ComparatorDistance());
                                ...
                                for (int iG = 0; iG < nbSourisG; iG++) {
                                        Node souris = graph.getNode(p1);
                                        listSouris.push(souris);
                                }

                                for (int iD = 0; iD < nbSourisD; iD++) {
                                        Node souris = graph.getNode(p2);                                       
                                        listSouris.push(souris);
                                }

                                int i = 0, actuel = 0, arrivees = 0;
                                Node depart = null;
                                Node arriveOne = graph.getNode("5:2");
                                Node arriveTwo = graph.getNode("43:1");
                                Node arrive = null;
                                
                                arriveOne.setName("Sortie");
                                arriveTwo.setName("Sortie");
                                ...
                                while (!listSouris.isEmpty()) {
                                    ...
                                    while (depart != arriveOne && depart != arriveTwo) {
                                        ...
                                        /*if (depart.getName().equals("grass") && !depart.isHerbe()) {
                                        ...
                                        graph.initEdge(depart.getId());

                                        System.out.println("souris " + actuel
                                                        + " position : " + depart.getId());
                                        
                                        System.out.println("actif : " + depart.getActif());
                                        
                                        Chaine listNode = new Chaine(new ComparatorDistance());
                                        Diksjtra.calculchemin(depart, listNode);                                                                                  
                                                                            
                                        arrive = listNode.get(listNode.size()-1);
                                        //System.out.println(" arrive " + listNode + " poid " + arrive.getMinDistance());
                                        while (arrive.getPrevious().getPrevious() != null){
                                            arrive = arrive.getPrevious();
                                            
                                        }
                                        
                                        System.out.println("souris : " + actuel + " va a  : " + arrive.getId());                                       
                                        
                                        //System.out.println("precedent : " + arrive.getPrevious().getId() + " actuel : " + arrive.getId());
                                       // arrive.setPrevious(null);
	...
	public void deplacerSouris(Node souris) {
		...
		for (int i = 0, j = 0; i < bufferMap.length(); i++) {
			...
			if (bufferMap.charAt(i) != '\n') {
				...
				if (souris != null) {
					...
					for (Node souri : souris) {
						if (souri.getId().equals(s)) {
